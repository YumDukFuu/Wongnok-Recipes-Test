...
<body>
        ...
        <div class="container">
            <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                <a class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
                    <!-- Logo -->
                    <h1 class="display-7 fw-bold">WongNok</h1>
                ...
                <!-- ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="login_page.php" class="nav-link px-2 link-dark">FAQs</a></li>
                    <li><a href="register.php" class="nav-link px-2 link-dark">About</a></li>
                </-ul -->

                
                <div class="col-md-3 text-end">
                    <a type="button" class="btn btn-outline-primary me-2" href="login_page.php">Create Content</a>
    ...
    <!-- Hero Section -->
        <div class="px-4 py-5 my-2 text-center">
                ...
                <h1 class="display-10 fw-bold">WongNok</h1>
